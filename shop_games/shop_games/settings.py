"""
Django settings for shop_games project.
...
SECRET_KEY = 'django-insecure-7*k=p*8es8tfpqbc-dsep-+k*jcw@6vs+bk&og4qcqeh$yq)s_'
...
WSGI_APPLICATION = 'shop_games.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "shop_games", "static"),
...
EMAIL_HOST_USER = '80e6725cd9583b'
